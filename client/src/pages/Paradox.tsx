      ...
      >
        ...
        <div style={{ borderTop: "1px solid rgba(57,255,20,0.08)", paddingTop: "1rem", display: "flex", justifyContent: "space-between" }}>
          <a
            ...
            className="font-mono"
            style={{ fontSize: "0.6rem", letterSpacing: "0.1em", color: "#39FF14", opacity: 0.25, textDecoration: "none", transition: "opacity 0.2s" }}
          ...
          <a
            ...
            className="font-mono"
            style={{ fontSize: "0.6rem", letterSpacing: "0.08em", color: "#39FF14", opacity: 0.25, textDecoration: "none", transition: "opacity 0.2s" }}
            onMouseEnter={(e) => { e.currentTarget.style.opacity = "0.7"; }}
            onMouseLeave={(e) => { e.currentTarget.style.opacity = "0.25"; }}
          >
