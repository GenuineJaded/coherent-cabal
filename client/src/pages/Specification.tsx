...
export default function Specification() {
  ...
  return (
    <div className="page-dark">
      ...
      <nav
        style={{
          borderBottom: "1px solid rgba(232,232,224,0.08)",
          padding: "1.25rem 0",
        }}
      >
        <div
        ...
        >
          ...
          <span
            className="font-mono"
            style={{ fontSize: "0.65rem", letterSpacing: "0.12em", color: "#E8E8E0", opacity: 0.2 }}
          >
            SPECIFICATION
          </span>
        </div>
      ...
      >
        {SPEC_SECTIONS.map((section, sIdx) => (
          <div key={sIdx} style={{ marginBottom: sIdx < SPEC_SECTIONS.length - 1 ? "0" : "0" }}>
            {/* Section label */}
            {section.label && (
              <p
                className="font-mono"
            ...
            {/* Main heading (first section only) */}
            {section.heading && (
              <>
                <h1
              ...
              return (
                <p
                  ...
                  style={{
                    ...
                    fontStyle:
                      section.heading && pIdx === 0
                        ? "italic"
                        : "normal",
                    color: "#E8E8E0",
                    opacity: section.heading && pIdx === 0 ? 0.65 : 1,
                  }}
                >
                  {para}
                </p>
